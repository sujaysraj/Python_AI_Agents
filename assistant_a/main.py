...
SELF_ID = "assistant_a"   # change to assistant_b in the other file
PEER_ID = "assistant_b"   # change to assistant_a in the other file
...
if SELF_ID == "assistant_a":
    send_message(to=PEER_ID, sender=SELF_ID, message="hello", msg_type="handshake")

handshake_done = SELF_ID == "assistant_b"  # B waits, A already sent
